  ...
  if (!isMounted) {
    ...
    return (
      ...
      >
        <TextField
          size='small'
          sx={!hidden && layout === 'vertical' ? { '& .MuiOutlinedInput-root': { borderRadius: 4 }, mr: 1, ml: -2.75 } : {'& .MuiOutlinedInput-root': { borderRadius: 4 }}}
          InputProps={{
            startAdornment: (
        ...
        />
        {/* <IconButton color='inherit' sx={!hidden && layout === 'vertical' ? { '& .MuiOutlinedInput-root': { borderRadius: 4 }, mr: 1, ml: -2.75 } : {'& .MuiOutlinedInput-root': { borderRadius: 4 }}}>
          <Magnify />
        </IconButton> */}
        <Dialog 
          fullWidth 
